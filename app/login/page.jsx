  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-br from-teal-900/90 via-slate-900/85 to-teal-800/90" />
      </div>

      {/* Login Card */}
      <Card className="w-full max-w-md relative z-10 border-teal-200 shadow-2xl">
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button type="button" variant="outline" className="bg-white border-border">
