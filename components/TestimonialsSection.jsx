  ...
  <div className="glass-card card-hover-effect rounded-lg px-6 py-8 flex-shrink-0 w-[280px] sm:w-[320px] md:w-[380px] flex flex-col group bg-white shadow-md">
    <div className="flex flex-col h-full">
      ...
      <div className="flex flex-col items-center text-center pt-6 border-t border-neutral-200 mt-auto">
        <div className="relative w-20 h-20 md:w-24 md:h-24 rounded-full overflow-hidden mb-4 ring-2 ring-indigo-200 group-hover:ring-indigo-400 transition-all duration-300">
          <Image
            src={review.avatar}
            alt={review.name}
            width={200}
...
export default function TestimonialsSection() {
  return (
    <section id="testimonials" className="py-16 sm:py-24 bg-indigo-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Section Header */}
        <div className="text-center mb-16 animate-fade-in">
          <span className="inline-block px-3 py-1 rounded-full bg-indigo-100 text-indigo-600 text-sm font-medium mb-4">
            TESTIMONIALS
          </span>
          <h2 className="text-3xl md:text-4xl font-bold text-neutral-800 mb-6">
            Loved by <span className="text-indigo-600">learners worldwide</span>
          </h2>
